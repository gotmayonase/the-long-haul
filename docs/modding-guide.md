...
9. [Key Gotchas and Verified IDs](#key-gotchas-and-verified-ids)
...
| `TwoHandWeapon = TRUE` | ✓ Yes | Engine enforces both hand slots |
...
- The two-hand equip restriction (`TwoHandWeapon`)
